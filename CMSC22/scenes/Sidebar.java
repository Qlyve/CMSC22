...
public class Sidebar {
    ...
    public Sidebar(double scale, String currentPage) {
        this.scale = scale;
    ...
    private void buildSidebar() {
        ...
        sidebarContainer.setPrefWidth(320 * scale);
        sidebarContainer.setStyle("-fx-background-color: #2F4156;");
    ...
    private Button createSidebarButton(String text) {
        ...
        button.setOnMouseEntered(e -> {
            ...
            if (!(boolean) button.getUserData()) {
                button.setStyle("-fx-background-color: #3A5169; -fx-text-fill: white; -fx-font-size: 14px;");
            }
        });
    ...
    private void highlightActiveButton(Button button, String pageName) {
        if (currentPage.equals(pageName)) {
            ...
            button.setStyle("-fx-background-color: #253344; -fx-text-fill: white; -fx-font-size: 14px; -fx-font-weight: bold;");
        }
    }
    ...
    private void navigateTo(String page) {
        switch(page) {
            case "Profile":
                ...
                SceneManager.switchTo(new ProfileScene("user"));
                break;
            case "Home":
            ...
            case "CourseCatalog":
                ...
                SceneManager.switchTo(new CourseCatalogScene());
                break;
            case "Planner":
            	System.out.println("Pressed Planner! Switching");
                SceneManager.switchTo(new PlannerScene("user"));
                break;
            case "AboutUs":
            	System.out.println("Pressed About Us! Switching");
                SceneManager.switchTo(new AboutUsScene());
                break;
        }
    }
